...
public class xuDongTest extends TestCase {
	...
	public void Deathafterbirth() throws ParseException {
		...
		String name = "name";
		boolean res = com.yutong.readParse.Sprint1_Checkout.death_After_Birth(
				date1, date2, name);
	...
	public void marriage_Before_Death() throws ParseException {
		...
		boolean res1 = com.yutong.readParse.Sprint1_Checkout
				.marriage_Before_Death(date1, date3, Husband_name);
		boolean res2 = com.yutong.readParse.Sprint1_Checkout
				.marriage_Before_Death(date2, date3, wife_name);
	...
	public void marrigeBeforeDivorce() throws ParseException {
		...
		boolean res = com.yutong.readParse.Sprint1_Checkout
				.marrigeBeforeDivorce(marriage, divorce);
	...
	public void divorceBeforeDeath() throws ParseException {
		...
		String id = "fdsafd";
		boolean res1 = com.yutong.readParse.Sprint1_Checkout
				.divorceBeforeDeath(divorce, husband, id);
		boolean res2 = com.yutong.readParse.Sprint1_Checkout
				.divorceBeforeDeath(divorce, wife, id);
	...
	public void dates_before_current_date() throws ParseException {
		...
		boolean res = com.yutong.readParse.Sprint1_Checkout
				.dates_Before_Current_Date(date, ID);
		System.out.println("test");
		Assert.assertTrue(
				"Alert: Dates (birth, death, marriage, divorce) should NOT be after the current date!",
				res == true);
	}
	...
	public void birth_before_marriage() throws ParseException {
		...
		String ID = "hfudilabfd";
		boolean res = com.yutong.readParse.Sprint1_Checkout
				.birth_Before_Marriage(birth, marriage, ID);
		Assert.assertTrue(
	...
	public void No_bigamy() throws ParseException {
		...
		boolean res = com.yutong.readParse.Sprint1_Checkout.No_bigamy("IN04",
				familyList);
		Assert.assertTrue(
				"Alert: Birth should occur before marriage of an individual!",
				res == true);
	...
	public void isValid() throws ParseException {
		...
		boolean output1 = com.yutong.readParse.Sprint1_Checkout
				.isValidDate("30 FEB 1995");
